...
namespace weatherLibrary
{
    ...
    { 
        ...
        {
            return "T="+temperature.ToString(System.Globalization.CultureInfo.InvariantCulture) +"°C, w="+windSpeed.ToString(System.Globalization.CultureInfo.InvariantCulture) +"km/h, h="+humidity.ToString(System.Globalization.CultureInfo.InvariantCulture) +"%";
        }
    }
}
